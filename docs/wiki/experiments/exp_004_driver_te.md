...
**Kaggle 제출 결과**: Public LB **0.94933** / Private **0.95004**. OOF 0.94952 vs Public 0.94933 → **갭 +0.00019** (OOF≈LB 재확인). LB 개선폭 +0.00499 ≈ OOF 개선폭 +0.00559 → 이득이 실데이터에 그대로 반영, Private 도 동반 상승(과적합 아님).
