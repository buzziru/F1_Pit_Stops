...
> 작성 2026-06-07 (마지막 레버 진행 중). 최종 **Private 0.95460 / 목표 0.95452 초과 +0.00008 / 158·3023팀 상위 5.2%**.
...
|---|---|---|
| **커밋/이슈 규율 부재** | 규칙적 커밋 없이 **커밋거리 다수 누적 방치**. 이슈 기반 작업순서·이슈 갱신 미흡 | **세션 끝 = 커밋+이슈 정리 의무**(또는 실험 회수+판정 단위 커밋). **이슈 = 작업 SSOT** — 시작 시 참조, 완료 시 갱신/close. (harness 훅으로 Stop 시 커밋 리마인드 가능) |
