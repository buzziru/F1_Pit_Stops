...
create_ms "M1 Baseline"      "베이스라인 파이프라인 + 첫 제출"
create_ms "M2 Feature Eng"   "피처 엔지니어링 반복"
create_ms "M3 Tuning"        "하이퍼파라미터 튜닝"
create_ms "M4 Ensemble"      "XGB/CatBoost + 스태킹/블렌딩"
create_ms "M5 Final"         "seed averaging + 최종 제출"
